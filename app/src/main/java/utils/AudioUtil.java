...
public class AudioUtil{
    ...
    private ArrayList<MediaPlayer.OnCompletionListener> mOnCompletionListeners = new ArrayList<MediaPlayer.OnCompletionListener>();
    ...
    private void startPlaying(final String fileName)
        ...
        try {
            ...
            am.setMode(android.media.AudioManager.STREAM_MUSIC);
            mPlayer.prepare();
            mPlayer.start();
            ...
            MediaPlayer.OnCompletionListener mOnCompletionListener = new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer arg0) {
                    ...
                    mPlayerEnd.start();
                    for (Iterator<MediaPlayer.OnCompletionListener> itr = mOnCompletionListeners
                            .iterator(); itr
                                 .hasNext();) {
                        MediaPlayer.OnCompletionListener curr = itr.next();
